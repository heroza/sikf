				...
				<header>
					<nav id="menu-bar">
						<ul>
							...
							<li class="with-submenu">
								<a href="<?php echo base_url(); ?>admin/profil">Edit Profil</a>
							</li>
							<li class="with-submenu">
								<a href="<?php echo base_url(); ?>admin/theme">Theme</a>
							</li>
							<!-- .keep makes the element aways visible (even in smaller screens) -->
							<li class="keep"><a href="<?php echo base_url(); ?>admin/logout" class="bt-alt">Logout</a></li>
						</ul>
					</nav>
				</header>
             </section>
