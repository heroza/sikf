...
{   $id_rubrik = $r['id_rubrik'];
	...
	$bobot_standar = $r['bobot'] + $bobot_standar;
	$data_kpi = $data_kpi."'".$r['sumber_referensi']."',";
}
$data4[] = "'".$sr['standar']."'";
$data5[] = round($sum_standar/$bobot_standar*100,2);	
$data6[] = $data_kpi;
$data7[] = $data_rubrik;
$data8[] = $sum_standar;
}
    ...
    <section id="pane">
    	...
    	<div id="pane-content">				
            ...
            <table class='table table-striped dataTable'>
                ...
                <tr><td>Total Nilai (%) </td><td> <?php echo $totalpersen2."%. [ Nilai Huruf = "; 
				if ($totalpersen2 > 85)
					{echo "A ]"; }
