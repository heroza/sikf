	...
	if (count($data['jadwal']->result_array())>0)
	{
	  ...
	  echo $totalpersen2;
                                ...
                                <?php if($l['validasi_auditor'] == 'Sudah') 
									{ ?>	
                                    <a href="<?php echo base_url()."pimpinan/hasil/".$l['id_jadwal']; ?>" target="_blank" title='Lihat Grafik Hasil Penilaian Audit'><img src="<?php echo base_url()."asset/img/bar.png" ?>">Lihat Grafik</a> 
									<a href="<?php echo base_url()."pimpinan/print_laporan_auditee/".$l['id_jadwal']; ?>" target="_blank" title='Cetak Laporan Audit'><img src="<?php echo base_url()."asset/img/printer.png" ?>">Cetak Laporan
                                <?php } 
									else{
									echo "Belum ada data";
									}?>
