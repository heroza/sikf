<section id="content">
						...
						<header>
							...
							<nav class="breadcrumbs">
								<ul>
									...
									<li><a href="<?php echo base_url()."auditee/pilih_laporan" ?>">Pilih Laporan</a></li>
								</ul>
							</nav>
						</header>
	...
	$data['jadwal'] = $this->Auditee_model->Total_Data("jadwal where id_jadwal = $id_jadwal AND validasi_auditor = 'Sudah'");
	if (count($data['jadwal']->result_array())>0)
	{
	  ...
	  echo $totalpersen2;
                                ...
                                <?php if($l['validasi_auditor'] == 'Sudah') 
									{ ?>	
                                    <a href="<?php echo base_url()."auditee/hasil/".$l['id_jadwal']; ?>" target="_blank" title='Lihat Grafik Hasil Penilaian Audit'><img src="<?php echo base_url()."asset/img/bar.png" ?>">Lihat Grafik</a> 
									<a href="<?php echo base_url()."auditee/print_laporan_auditee/".$l['id_jadwal']; ?>" target="_blank" title='Cetak Laporan Audit'><img src="<?php echo base_url()."asset/img/printer.png" ?>">Cetak Laporan
                                <?php } 
									else{
									echo "Belum ada data";
									}?>
